            ...
            <>
              ...
              <div className=" h-[30rem] p-8">
                <div className="flex items-center h-full">
                  ...
                  <div className="flex grow place-content-end h-full">
                    <div>
                      <Search />
                    </div>
                  </div>
